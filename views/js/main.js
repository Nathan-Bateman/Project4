...
var resizePizzas = function(size) { 
  ...
  function changePizzaSizes(size) {
    var randoms = document.querySelectorAll(".randomPizzaContainer");
    var getRandoms# = document.querySelectorAll(".randomPizzaContainer").length;
    for (var i = 0; i < getRandoms#; i++) {
